...
def main():
    ...
    # Header
    st.markdown(
        '<h1 class="main-header">🤖 Maya Advanced FAQ Chatbot</h1>',
    ...
    if mode == 'voice':
        ...
        if st.session_state.get('voice_mode_active', False):
            ...
            if (
                current_time - st.session_state.last_voice_check > 2.0
        ...
        render_text_mode_ui(st.session_state.chat_history, handle_user_input)
